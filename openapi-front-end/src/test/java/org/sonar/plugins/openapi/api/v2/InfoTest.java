...
public class InfoTest extends BaseNodeTest<OpenApi2Grammar> {
  @Test
  public void can_parse_info_with_missing_optionals() {
    JsonNode node = parseResource(OpenApi2Grammar.INFO, "/models/shared/info/minimal.yaml");
  ...
  public void can_parse_info_with_flow() {
    JsonNode node = parseResource(OpenApi2Grammar.INFO, "/models/shared/info/withFlow.yaml");
  ...
  public void can_parse_full_info() {
    JsonNode node = parseResource(OpenApi2Grammar.INFO, "/models/shared/info/full.yaml");
  ...
  public void throws_when_parsing_incomplete_object() {
    parseResource(OpenApi2Grammar.INFO, "/models/shared/info/incomplete.yaml");
  }
}
