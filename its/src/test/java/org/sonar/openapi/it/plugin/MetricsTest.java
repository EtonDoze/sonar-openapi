...
import static org.sonar.openapi.it.plugin.Tests.getMeasure;
import static org.sonar.openapi.it.plugin.Tests.getMeasureAsDouble;
...
public class MetricsTest {
  ...
  public static void startServer() {
    ...
    SonarScanner build = SonarScanner.create()
      ...
      .setSourceDirs("src")
      .setProperty("sonar.openapi.path.v2","src/openapi/v2/**");
